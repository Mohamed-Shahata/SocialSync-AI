...
export default function GoogleAuthButton() {
  ...
  return (
    <a
      href={googleLoginUrl}
      className="mt-4 flex w-full items-center justify-center gap-2 rounded-lg border border-border bg-white px-4 py-2.5 text-sm font-medium text-foreground hover:bg-gray-50"
    >
